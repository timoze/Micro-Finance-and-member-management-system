				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Amount Given Out</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Amount Issued Out <?php echo $desc; ?></h3>
						<div class="container">
							<form method="post" name="search" action="clients_loans_given.php">
						...
						{ 
							...
							$url = "clients_loans_given.php?date1=$date_from&date2=$date_to";
						...
						?>
						<div class="graph">
							<form name="form1" method="post" action="clients_loans_given.php">
							<div class="tables">
	...
	$action = '<div class="dropdown">
                    ...
                    ?>
										...
										<input type=hidden name=client_id'<?php echo $row->ID;?>' value="">
									   	...
									   	$total_amount += $client_bal[0]; 
									   	$total_repayment_amount += $client_bal[1]; 
									...
									<tr class="active">
									      	...
									      	<th colspan="4" style="text-align: center;">Totals Loans Given</th>
									      
									        <th style="text-align: right;"><?php print number_format($total_amount,2);?></th>
									        <th style="text-align: right;"><?php print number_format($total_repayment_amount,2);?></th>
